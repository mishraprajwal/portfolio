    ...
    loader.load('/assets/images/laptop.avif', (texture) => {
      ...
      const fragmentShader = `
        ...
        void main() {
          ...
          // Multiply color by mask to reveal
      ...
      const onMove = (e) => {
        ...
        if (mesh) {
          gsap.to(mesh.rotation, { x: y * 0.15, y: x * 0.25, duration: 0.9, ease: 'power3.out' })
          gsap.to(mesh.position, { x: x * 0.14, y: y * 0.08, duration: 0.9, ease: 'power3.out' })
        }
      }
